                    ...
                    <div class="flex flex-col mt-2">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                <form action="{{ route('time.insert') }}" method="POST" class="w-full">
                                    @csrf
                                    <label class="text-xl" for="work">Worked on:</label>
                                    <textarea rows="10" class="w-full mt-2 py-2 px-4" id="work" name="work" required></textarea>
                                    <div class="w-full mt-4 flex">
                                        ...
                                        <label class="text-xl" for="stop">Stop time:</label>
                                            <input required type="datetime-local" id="stop" name="stop">
                                        </div>
                                    </div>
                                    <div class="flex justify-center">
                                    <input class="bg-blue-500 hover:bg-blue-700 text-xl text-white font-bold py-2 px-4 rounded-full mt-4 w-4/12" type="submit" value="Submit">
                                    </div>
                                </form>
                            </div>
                        </div>
